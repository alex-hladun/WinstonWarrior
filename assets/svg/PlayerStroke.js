import Svg, { Path, Line, G, Ellipse, Circle } from "react-native-svg";
import React from "react";
import { Theme } from "../styles/Theme";

export default function PlayerStroke({}) {
  return (
    <Svg
    ...
    //           <Path
    //             id="XMLID_1997_"
    //             d="m159.197 414.479c-13.967 0-25.29 11.323-25.29 25.29 0 13.967 11.323 25.29 25.29 25.29h19.493c8.75 0 16.878-4.523 21.49-11.958l23.96-38.622z"
    //             fill="#b5bac6"
    //           />
    //         </G>
    //         <Path
    //           id="XMLID_3077_"
    //           d="m376.907 501.979h86.917c6.121 0 11.083-4.962 11.083-11.083v-30.917h-71c-14.912 0-27 12.088-27 27z"
    //           fill="#f8f8f8"
    //         />
    //         <Path
    //           id="XMLID_3026_"
    //           d="m474.907 253.979v79 127h-44.814l-20.186-106v-120l65-43z"
    //           fill="#a9dcf3"
    //         />
    //         <Path
    //           id="XMLID_2962_"
    //           d="m409.907 233.979-50.728-83.417 26.101-68.343c33.477 27.393 61.734 60.602 83.414 98.033l6.213 10.727z"
    //           fill="#e79b6e"
    //         />
    //         <G id="XMLID_2628_">
    //           <Path
    //             id="XMLID_2666_"
    //             d="m323.299 277.729c-3.375 0-6.796-.854-9.933-2.654-9.582-5.496-12.894-17.719-7.397-27.3l12.512-21.812c22.354-38.969 34.17-83.312 34.17-128.237 0-11.046 8.954-20 20-20s20 8.954 20 20c0 51.898-13.649 103.124-39.473 148.141l-12.512 21.811c-3.696 6.444-10.436 10.051-17.367 10.051z"
    //             fill="#e79b6e"
    //           />
    //         </G>
    //         <Path
    //           id="XMLID_2951_"
    //           d="m356.221 85.974c-13.059 13.059-34.231 13.059-47.29 0l-18.911-18.911c-13.059-13.059-13.059-34.231 0-47.29 13.059-13.059 34.231-13.059 47.29 0l18.911 18.911c13.058 13.059 13.058 34.232 0 47.29z"
    //           fill="#d0a084"
    //         />
    //         <Path
    //           id="XMLID_1993_"
    //           d="m342.979 25.443-5.67-5.67c-13.059-13.059-34.231-13.059-47.29 0-13.059 13.059-13.059 34.231 0 47.29l5.67 5.67z"
    //           fill="#a9dcf3"
    //         />
    //       </G>
    //       <Path
    //         id="XMLID_2038_"
    //         d="m37.07 64.856 76.667 35.267-76.667 35.267z"
    //         fill="#d8727e"
    //       />
    //       <Ellipse
    //         id="XMLID_2070_"
